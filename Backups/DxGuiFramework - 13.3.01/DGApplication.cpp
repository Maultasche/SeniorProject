...
void DGApplication::RunApp(void)
{
   ...
   while(!terminateApp)
   {
      ...
      if(appActive)
      {
         ...
         //Temporary - output input events
         InputEvent* inputEvent;
         while(dgInput->EventsInQueue())
         {
            inputEvent = dgInput->RemoveEvent();
            switch(inputEvent->messageType)
            {
               case WM_CHAR:
                  outputFile << "WM_CHAR" << endl;
                  break;
               case WM_KEYDOWN:
                  outputFile << "WM_KEYDOWN" << endl;
                  break;
               case WM_KEYUP:
                  outputFile << "WM_KEYUP" << endl;
                  break;
               case WM_SYSKEYDOWN:
                  outputFile << "WM_SYSKEYDOWN" << endl;
                  break;
               case WM_SYSKEYUP:
                  outputFile << "WM_SYSKEYUP" << endl;
                  break;
               case WM_LBUTTONDBLCLK:
                  outputFile << "WM_LBUTTONDBLCLK" << endl;
                  break;
               case WM_LBUTTONDOWN:
                  outputFile << "WM_LBUTTONDOWN" << endl;
                  break;
               case WM_LBUTTONUP:
                  outputFile << "WM_LBUTTONUP" << endl;
                  break;
               case WM_MBUTTONDBLCLK:
                  outputFile << "WM_MBUTTONDBLCLK" << endl;
                  break;
               case WM_MBUTTONDOWN:
                  outputFile << "WM_MBUTTONDOWN" << endl;
                  break;
               case WM_MBUTTONUP:
                  outputFile << "WM_MBUTTONUP" << endl;
                  break;
               case WM_RBUTTONDBLCLK:
                  outputFile << "WM_RBUTTONDBLCLK" << endl;
                  break;
               case WM_RBUTTONDOWN:
                  outputFile << "WM_RBUTTONDOWN" << endl;
                  break;
               case WM_RBUTTONUP:
                  outputFile << "WM_RBUTTONUP" << endl;
                  break;
               case WM_MOUSEMOVE:
                  outputFile << "WM_MOUSEMOVE" << endl;
                  break;
               default:
                  outputFile << "Unknown message" << endl;
            }
