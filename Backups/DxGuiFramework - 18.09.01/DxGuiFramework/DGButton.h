...
Description: This file contains the DGButton class, which is a a button
...
public:
   ...
   DGButton(UINT winID, DGWindow* parentWin, const DGPoint& position, 
      ...
      char* text = "", DGFont font = DGFont("MS Sans Serif", 32));
...
protected:
   ...
   void OnChildWindowMessage(DGMessage* msg);
