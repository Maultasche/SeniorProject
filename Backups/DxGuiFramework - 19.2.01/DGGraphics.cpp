...
void FC DGGraphics::LockSurface(void)
{
   ...
   videoBuffer = (BYTE*)ddsd.lpSurface;
...
void FC DGGraphics::FlipSurface(void)
{
   ...
   {
      OutputDebugString("FullScreen - single buffer\n");
      return;
   }
   ...
   {
      OutputDebugString("FullScreen - persistence\n");
   ...
   {
      OutputDebugString("FullScreen - normal\n");
