...
DGBitmap::DGBitmap(UINT bitmapID, UINT bitmapPriority, 
                   const char* bitmapFileName, DGArea& bitmapDimensions)
{
   id = bitmapID;
   priority = bitmapPriority;
...
void FC DGBitmap::LoadBitmap(const char* bitmapFileName)
{
   HRESULT result;
...
void FC DGBitmap::LoadBitmap(const char* bitmapFileName, DGArea& bitmapDimensions)
{
   HRESULT result;
...
void DGBitmap::LoadBitmapFromFile(DGArea& rect, const char* bitmapFileName)
{
   char message[256];
...
DGPoint DGBitmap::FindBitmapSize(const char* bitmapFileName)
{
   char message[256];
