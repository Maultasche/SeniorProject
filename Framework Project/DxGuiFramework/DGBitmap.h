...
public:
   ...
   DGBitmap(UINT bitmapID, UINT bitmapPriority, UINT resourceID,
      DGArea& dimensions);
   DGBitmap(UINT bitmapID, UINT bitmapPriority, 
      const char* bitmapFileName);
   DGBitmap(UINT bitmapID, UINT bitmapPriority, 
      const char* bitmapFileName, DGArea& dimensions);
   virtual ~DGBitmap();
   ...
   void FC LoadBitmap(UINT resourceID, DGArea& bitmapDimensions);
...
private:
   void LoadBitmapFromFile(DGArea& rect, const char* bitmapFileName);
   DGPoint FindBitmapSize(const char* bitmapFileName);
